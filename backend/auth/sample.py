...
if detector.empty():
    print("Error: Could not load Haar Cascade XML file. Check the file path.")
    exit(1)
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.imwrite("Jarvis-2025-master\\backend\\auth\\trainer\\samples" + str(face_id) + '.' + str(count) + ".jpg", converted_image[y:y+h,x:x+w])
